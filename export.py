                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                               os.popen("git push origin main")
                                                                                                                                                                                                                                                                                                                               pg.sleep(2)
                                                                                                                                                                                                                                                                                                                                               ~ data = subprocess.check_output(["git", "add", "."]).decode("utf-8").split("\n")
                                                                                                                                                                                                                                                                                                                                                               ~ pg.sleep(3)                ~ data = subprocess.check_output(["git", "commit", "-m", "new"]).decode("utf-8").split("\n")                ~ pg.sleep(3)                ~ data = subprocess.check_output(["git", "push", "origin", "main"]).decode("utf-8").split("\n")
                                                                                                                                                                                                                                                                                                                                                                               ~ pg.moveTo(1300,1054)
                                                                                                                                                                                                                                                                                                                                                                                               ~ pg.click()
                                                                                                                                                                                                                                                                                                                                                                                                               ~ pg.sleep(1)
                                                                                                                                                                                                                                                                                                                                                                                                                               ~ pg.write(i)
